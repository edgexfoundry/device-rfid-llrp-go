...
// Code generated by "generate_param_code.py -i messages.yaml -o generated_unmarshal.go"; DO NOT EDIT.
...
type SetReaderConfigFlags uint8
...
func (m *getReaderCapabilities) UnmarshalBinary(data []byte) error {
	...
	m.ReaderCapabilitiesRequestedData = data[0]
	data = data[1:]
...
func (m *addAccessSpec) UnmarshalBinary(data []byte) error {
	if len(data) < 43 {
		return errors.Errorf("ParamAddAccessSpec requires at least 43 bytes "+
			"but only %d are available", len(data))
	}
...
func (m *getReaderConfigResponse) UnmarshalBinary(data []byte) error {
	...
	if subType := ParamType(binary.BigEndian.Uint16(data)); subType == ParamEventsAndReports {
		...
		*m.EventsAndReports = eventsAndReports(EventsandReportsFlags(data[4]))
		data = data[subLen:]
	}
...
type setReaderConfig struct {
	SetReaderConfigFlags        SetReaderConfigFlags
	ReaderEventNotificationSpec *readerEventNotificationSpec
	AntennaProperties           []antennaProperties
	AntennaConfiguration        []antennaConfiguration
	ROReportSpec                *roReportSpec
...
func (m *setReaderConfig) UnmarshalBinary(data []byte) error {
	...
	m.SetReaderConfigFlags = SetReaderConfigFlags(data[0])
	data = data[1:]
...
func (p *generalDeviceCapabilities) UnmarshalBinary(data []byte) error {
	...
	if arrLen := int(binary.BigEndian.Uint16(data[11:])); arrLen > len(data[13:]) {
...
func (p *frequencyHopTable) UnmarshalBinary(data []byte) error {
	...
	p.HopTableID = data[0]
	if arrLen := int(binary.BigEndian.Uint16(data[2:])); arrLen*4 > len(data[4:]) {
		return errors.Errorf("Frequencies ([]kHz) declares it has %d bytes, but only %d bytes are available", arrLen*4, len(data[4:]))
	} else if arrLen != 0 {
...
func (p *fixedFrequencyTable) UnmarshalBinary(data []byte) error {
	...
	if arrLen := int(binary.BigEndian.Uint16(data)); arrLen*4 > len(data[2:]) {
		return errors.Errorf("Frequencies ([]kHz) declares it has %d bytes, but only %d bytes are available", arrLen*4, len(data[2:]))
	} else if arrLen != 0 {
		p.Frequencies = make([]kHz, arrLen)
...
func (p *aiSpec) UnmarshalBinary(data []byte) error {
	...
	if arrLen := int(binary.BigEndian.Uint16(data)); arrLen*2 > len(data[2:]) {
		return errors.Errorf("AntennaID ([]uint16) declares it has %d bytes, but only %d bytes are available", arrLen*2, len(data[2:]))
	} else if arrLen != 0 {
...
func (p *accessSpec) UnmarshalBinary(data []byte) error {
	if len(data) < 39 {
		return errors.Errorf("ParamAccessSpec requires at least 39 bytes "+
			"but only %d are available", len(data))
	}
...
func (p *accessCommand) UnmarshalBinary(data []byte) error {
	if len(data) < 16 {
		return errors.Errorf("ParamAccessCommand requires at least 16 bytes "+
			"but only %d are available", len(data))
	}
...
func (p *gpoWriteData) UnmarshalBinary(data []byte) error {
	...
	p.GPOWriteFlags = GPOWriteFlags(data[2])
	return nil
}
...
type antennaProperties struct {
	AntennaPropertiesFlags AntennaPropertiesFlags
	AntennaID              uint16
	AntennaGain            dBiX100
}
...
func (p *antennaProperties) UnmarshalBinary(data []byte) error {
	...
	p.AntennaPropertiesFlags = AntennaPropertiesFlags(data[0])
...
type gpiPortCurrentState struct {
	GPIPort            uint16
	GPIPortConfigFlags GPIPortConfigFlags
...
func (p *gpiPortCurrentState) UnmarshalBinary(data []byte) error {
	...
	p.GPIPortConfigFlags = GPIPortConfigFlags(data[2])
	p.GPIState = GPIStateType(data[3])
	return nil
}

// eventsAndReports is Parameter 226, EventsAndReports.
type eventsAndReports EventsandReportsFlags
...
func (p *eventsAndReports) UnmarshalBinary(data []byte) error {
	...
	*p = eventsAndReports(EventsandReportsFlags(data[0]))
	return nil
}
...
type tagReportContentSelector struct {
	TagReportContentSelectorFlags TagReportContentSelectorFlags
...
func (p *tagReportContentSelector) UnmarshalBinary(data []byte) error {
	...
	p.TagReportContentSelectorFlags = TagReportContentSelectorFlags(binary.BigEndian.Uint16(data))
	data = data[2:]
...
func (p *epcData) UnmarshalBinary(data []byte) error {
	...
	if arrLen := int(binary.BigEndian.Uint16(data)) & 7; arrLen > len(data[2:]) {
...
func (p *readerExceptionEvent) UnmarshalBinary(data []byte) error {
	...
	if arrLen := int(binary.BigEndian.Uint16(data)); arrLen > len(data[2:]) {
...
func (p *c1G2TagInventoryMask) UnmarshalBinary(data []byte) error {
	...
	p.C1G2MemoryBank = data[0]
	p.MostSignificantBit = binary.BigEndian.Uint16(data[1:])
	if arrLen := int(binary.BigEndian.Uint16(data[3:])) & 7; arrLen > len(data[5:]) {
...
func (p *c1G2TagSpec) UnmarshalBinary(data []byte) error {
	if len(data) < 12 {
		return errors.Errorf("ParamC1G2TagSpec requires at least 12 bytes "+
			"but only %d are available", len(data))
	}
...
func (p *c1G2TargetTag) UnmarshalBinary(data []byte) error {
	if len(data) < 8 {
		return errors.Errorf("ParamC1G2TargetTag requires at least 8 bytes "+
			"but only %d are available", len(data))
	}

	p.C1G2MemoryBank = data[0]
	p.MatchFlag = data[1] != 0
	p.MostSignificantBit = binary.BigEndian.Uint16(data[2:])
	if arrLen := int(binary.BigEndian.Uint16(data[4:])) & 7; arrLen > len(data[6:]) {
		return errors.Errorf("TagMask (bit array) declares it has %d bytes, but only %d bytes are available", arrLen, len(data[6:]))
	} else if arrLen != 0 {
		p.TagMask = make([]byte, arrLen)
		for i := 0; i < arrLen; i++ {
			p.TagMask[i] = data[i]
	...
	if arrLen := int(binary.BigEndian.Uint16(data[4:])) & 7; arrLen > len(data[6:]) {
		return errors.Errorf("TagData (bit array) declares it has %d bytes, but only %d bytes are available", arrLen, len(data[6:]))
	} else if arrLen != 0 {
...
func (p *c1G2Write) UnmarshalBinary(data []byte) error {
	...
	p.C1G2MemoryBank = data[6]
	p.WordAddress = binary.BigEndian.Uint16(data[7:])
	if arrLen := int(binary.BigEndian.Uint16(data[9:])); arrLen*2 > len(data[11:]) {
		return errors.Errorf("Data ([]uint16) declares it has %d bytes, but only %d bytes are available", arrLen*2, len(data[11:]))
	} else if arrLen != 0 {
...
func (p *c1G2ReadOpSpecResult) UnmarshalBinary(data []byte) error {
	...
	if arrLen := int(binary.BigEndian.Uint16(data[3:])); arrLen*2 > len(data[5:]) {
		return errors.Errorf("Data ([]uint16) declares it has %d bytes, but only %d bytes are available", arrLen*2, len(data[5:]))
	} else if arrLen != 0 {
		p.Data = make([]uint16, arrLen)
...
func (p *c1G2BlockPermalock) UnmarshalBinary(data []byte) error {
	...
	if arrLen := int(binary.BigEndian.Uint16(data[9:])); arrLen*2 > len(data[11:]) {
		return errors.Errorf("BlockMask ([]uint16) declares it has %d bytes, but only %d bytes are available", arrLen*2, len(data[11:]))
	} else if arrLen != 0 {
...
func (p *c1G2GetBlockPermalockStatusOpSpecResult) UnmarshalBinary(data []byte) error {
	...
	p.OpSpecID = binary.BigEndian.Uint16(data[1:])
	if arrLen := int(binary.BigEndian.Uint16(data[3:])); arrLen*2 > len(data[5:]) {
		return errors.Errorf("PermalockStatus ([]uint16) declares it has %d bytes, but only %d bytes are available", arrLen*2, len(data[5:]))
	} else if arrLen != 0 {
