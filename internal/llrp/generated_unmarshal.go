...
// Code generated by "generate_param_code.py -i messages.yaml --test-file=binary_test.go --marshal-file=generated_marshal.go --unmarshal-file=generated_unmarshal.go"; DO NOT EDIT.
package llrp
...
// dBm16 is a 16-bit dBm value.
// In LLRP, it's used for maximum receive sensitivity.
type dBm16 = int16

// dBm8 is a 8-bit dBm value.
// In LLRP, it's used to represent RSSI.
type dBm8 = int8

// dBiX100 is dBi*100, i.e., 0.01dBi or 1 millibel.
// In LLRP, it's used for fractional dBi antenna gain values.
type dBiX100 = uint16

// dBmX100 is dBm*100, i.e., 0.01dBm or 1 millibel milliwatt.
// In LLRP, it's used primarily for fractional dBm transmit power
// values.
type dBmX100 = uint16

// dB or decibel is 1/10 of a bel,
// which is the either the log10 of the ratio of a power quantity
// relative a reference,
// or 2*log10 of the ratio of an amplitude quantity relative a
// reference field.
// In LLRP, it's used primarily for receive sensitivity values
// relative the device maximum sensitivity.
type dB = uint16

// microSecs64 is a 64-bit number of microseconds.
// It's usually used to represent a time offset since a known
// reference,
...
// accessing tags.
// The air protocol determines how tags are sigulated and access
...
// By default, this package will attempt to establish connection with
// Readers
...
// the Client will negotiate versions with the Reader and downgrade if
// necessary.
...
// These are described in Section 14 of the Low Level Reader Protocol
// v1.0.1
